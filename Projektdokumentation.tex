...
\begin{document}
	...
	% Hier entsprechend EINEN Teile auskommentieren und vor allem TITELPAGE IMMER anpassen!!!
	\include{pages/content/1_Projektidee}
	%\include{pages/content/2_Projektkonzept}
	%\include{pages/content/3_Projektdefinition}
	%\include{pages/content/4_Projektablaufplan}
